...
namespace Ignis {
    ...
    Vulkan::GraphicsPipelineBuilder &Vulkan::GraphicsPipelineBuilder::setFragmentShader(
        const std::string_view entry_point,
        const vk::ShaderModule module) {
        ShaderStageInfo shader_stage{};
        shader_stage.EntryPoint = entry_point;
    ...
    Vulkan::GraphicsPipelineBuilder &Vulkan::GraphicsPipelineBuilder::setVertexLayouts(const vk::ArrayProxy<VertexLayout> &vertex_layouts) {
        m_VertexInputBindingDescriptions.clear();
        m_VertexInputAttributeDescriptions.clear();
    ...
    Vulkan::GraphicsPipelineBuilder &Vulkan::GraphicsPipelineBuilder::setInputTopology(const vk::PrimitiveTopology topology) {
        m_InputAssembly.setTopology(topology);
        return *this;
    }

    Vulkan::GraphicsPipelineBuilder &Vulkan::GraphicsPipelineBuilder::setPolygonMode(const vk::PolygonMode polygon_mode) {
        m_Rasterization.setPolygonMode(polygon_mode);
        return *this;
    }

    Vulkan::GraphicsPipelineBuilder &Vulkan::GraphicsPipelineBuilder::setCullMode(
    ...
    Vulkan::GraphicsPipelineBuilder &Vulkan::GraphicsPipelineBuilder::setColorAttachmentFormats(const vk::ArrayProxy<vk::Format> &formats) {
    ...
    Vulkan::GraphicsPipelineBuilder &Vulkan::GraphicsPipelineBuilder::setDepthAttachmentFormat(const vk::Format format) {
    ...
    Vulkan::GraphicsPipelineBuilder &Vulkan::GraphicsPipelineBuilder::setBlendingAlphaBlended() {
        m_ColorBlendAttachment
            .setColorWriteMask(vk::ColorComponentFlagBits::eR |
                               vk::ColorComponentFlagBits::eG |
                               vk::ColorComponentFlagBits::eB |
    ...
    Vulkan::GraphicsPipelineBuilder &Vulkan::GraphicsPipelineBuilder::setNoMultisampling() {
        m_Multisample
    ...
    Vulkan::GraphicsPipelineBuilder &Vulkan::GraphicsPipelineBuilder::setNoBlending() {
        m_ColorBlendAttachment
            .setColorWriteMask(vk::ColorComponentFlagBits::eR |
                               vk::ColorComponentFlagBits::eG |
                               vk::ColorComponentFlagBits::eB |
    ...
    Vulkan::GraphicsPipelineBuilder &Vulkan::GraphicsPipelineBuilder::setNoDepthTest() {
        m_DepthStencil
    ...
    vk::Pipeline Vulkan::GraphicsPipelineBuilder::build(const vk::PipelineLayout layout) {
        ...
        auto [result, pipeline] = s_pInstance->m_Device.createGraphicsPipeline(nullptr, graphics_pipeline_create_info);
        DIGNIS_VK_CHECK(result);
        return pipeline;
    }

    void Vulkan::DestroyPipelineLayout(const vk::PipelineLayout layout) {
        DIGNIS_ASSERT(nullptr != s_pInstance, "Ignis::Vulkan is not initialized.");
        s_pInstance->m_Device.destroyPipelineLayout(layout);
    }

    void Vulkan::DestroyPipeline(const vk::Pipeline pipeline) {
        DIGNIS_ASSERT(nullptr != s_pInstance, "Ignis::Vulkan is not initialized.");
        s_pInstance->m_Device.destroyPipeline(pipeline);
    }

    vk::PipelineLayout Vulkan::CreatePipelineLayout(
        ...
        auto [result, layout] = s_pInstance->m_Device.createPipelineLayout(create_info);
        DIGNIS_VK_CHECK(result);
        return layout;
    }

    vk::Pipeline Vulkan::CreateComputePipeline(
        ...
        auto [result, pipeline] = s_pInstance->m_Device.createComputePipeline(nullptr, create_info);
        DIGNIS_VK_CHECK(result);
        return pipeline;
    }
}  // namespace Ignis