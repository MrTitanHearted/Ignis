...
namespace Ignis {
    ...
    namespace KeyMod {
        ...
        enum flag : Flags {
            ...
            eShiftBit    = GLFW_MOD_SHIFT,
            eControlBit  = GLFW_MOD_CONTROL,
            eAltBit      = GLFW_MOD_ALT,
            eSuperBit    = GLFW_MOD_SUPER,
            eCapsLockBit = GLFW_MOD_CAPS_LOCK,
            eNumLockBit  = GLFW_MOD_NUM_LOCK,
    ...
    std::string_view GetKeyCodeName(KeyCode key);
    std::string_view GetKeyModFlagsName(KeyMod::Flags mods);
    std::string_view GetKeyActionName(KeyAction action);
    std::string_view GetMouseButtonName(MouseButton button);
    std::string_view GetCursorModeName(CursorMode mode);
}  // namespace Ignis